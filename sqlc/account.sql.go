...
VALUES ($1, $2, $3) RETURNING id, owner, balance, currentcy, created_at
`
...
func (q *Queries) CreateAccount(ctx context.Context, arg CreateAccountParams) (Account, error) {
	row := q.db.QueryRowContext(ctx, createAccount, arg.Owner, arg.Balance, arg.Currentcy)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.Owner,
...
SELECT id, owner, balance, currentcy, created_at
FROM accounts
WHERE id = $1 LIMIT 1
`
...
UPDATE accounts
set balance = $2
WHERE id = $1 RETURNING id, owner, balance, currentcy, created_at
`
